...
/**
 * Action for removing a substream.
 *
 * ActionInformationSource.isEnabled() should support the "RemoveSubstreamAction" action.
 *
 ...
 */
public class RemoveSubstreamAction extends GroupableAction {
...
//    private StreamsViewer viewer;
     ...
     */
    public RemoveSubstreamAction(StreamsViewer viewer, ActionInformationSource infoSource) {
//        this.viewer = viewer;
        this.infoSource = infoSource;

        putValue(Action.NAME, "Remove substream...");
    }

    public void update() {
        setEnabled(infoSource.isActionEnabled("RemoveSubstreamAction"));
    }

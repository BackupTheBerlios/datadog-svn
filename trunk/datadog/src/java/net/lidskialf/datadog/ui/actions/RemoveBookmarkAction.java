...
/**
 * Action for removing a bookmark.
 *
 * ActionInformationSource.isEnabled() should support the "RemoveBookmarkAction" action.
 *
 ...
 */
public class RemoveBookmarkAction extends GroupableAction {
     ...
     */
    public RemoveBookmarkAction(StreamsViewer viewer, ActionInformationSource infoSource) {
        this.viewer = viewer;
        this.infoSource = infoSource;

        putValue(Action.NAME, "Remove bookmark...");
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (position != null) {
            if (JOptionPane.showConfirmDialog(null,
                ...
                viewer.removeBookmark(position.longValue());
            }
        }
    }
     ...
     */
    public void update() {
        setEnabled(infoSource.isActionEnabled("RemoveBookmarkAction"));
    }
}

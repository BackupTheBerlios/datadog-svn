...
public class StreamsViewerColumnHeader extends JPanel 
  implements StreamsViewerChangeListener, MouseMotionListener {
  ...
  public void mouseMoved(MouseEvent arg0) {
    ...
    if (newSelectorPos != absoluteSelectorPos) {
      ...
      if (oldSelectorPos != -1) repaint(viewer.absolutePositionToPanelXPosition(oldSelectorPos), 0, 1, getHeight());
